...
modalAddPro.addEventListener('show.bs.modal', function (event) {
    ...
    if (formAction == 'add') {
        ...
        var proOriginPrice = parseInt(btnTrigger.getAttribute('data-bs-proOriginPrice'));
        ...
        document.getElementById('inputSpec').value = proSpec.replace(/,/g, '\n');
        //chỉnh lại giao diện 1 chút
        document.getElementById('exampleModalLabel').innerHTML = 'Sửa gì nào bạn ơii';
        ...
        btnsubmit.onclick = function () {
            ...
            op = 4;
            formAdd.action = '/admin/product/' + op + '/' + proID + '?_method=PUT';
            formAdd.submit();
            // alert(a.value);
        }
    }
